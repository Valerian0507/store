 ...
 */
final class Version20260319145848 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE order_items (id INT AUTO_INCREMENT NOT NULL, product_name VARCHAR(255) NOT NULL, unit_price_cents INT NOT NULL, quantity INT NOT NULL, order_id INT NOT NULL, product_id INT DEFAULT NULL, INDEX IDX_62809DB08D9F6D38 (order_id), INDEX IDX_62809DB04584665A (product_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE orders (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, updated_at DATETIME DEFAULT NULL, order_number VARCHAR(50) DEFAULT NULL, status VARCHAR(50) NOT NULL, total_cents INT NOT NULL, shipping_first_name VARCHAR(120) DEFAULT NULL, shipping_last_name VARCHAR(120) DEFAULT NULL, shipping_street VARCHAR(120) DEFAULT NULL, shipping_city VARCHAR(120) DEFAULT NULL, shipping_postal_code VARCHAR(50) DEFAULT NULL, shipping_country VARCHAR(50) DEFAULT NULL, user_id INT NOT NULL, UNIQUE INDEX UNIQ_E52FFDEE551F0F81 (order_number), INDEX IDX_E52FFDEEA76ED395 (user_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
